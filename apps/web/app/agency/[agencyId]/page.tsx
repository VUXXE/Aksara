...
import { getAgencyDetails } from "@/lib/queries/agency";
import { getSubAccountsByAgency } from "@/lib/queries/subaccount";
...
const AgencyIdPage: React.FC<AgencyIdPageProps> = async ({ params }) => {
    ...
    if (!agencyId) return redirect("/agency/unauthorized");
    ...
    if (!agencyDetails) return redirect("/agency/unauthorized");
